...
public interface NotifyLikeService {

    String ENDPOINT = "http://www.json-generator.com/api/json/get/";

    //데이터를 가져오는 인터페이스
    @GET("cfSbkMbfNe")
    Observable<List<NotifyLike>> getNotifyLike();

    //구현은 레트로핏이 해줌
    class Creator {
        public static NotifyLikeService newNotifyLikeService() {
            ...
            return retrofit.create(NotifyLikeService.class);
        }
