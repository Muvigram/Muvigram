...
public interface NotifyCommentService {

    String ENDPOINT = "http://www.json-generator.com/api/json/get/";

    //데이터를 가져오는 인터페이스
    @GET("cqMKdUoRFe")
    Observable<List<NotifyComment>> getNotifyComment();

    //구현은 레트로핏이 해줌
    class Creator {
        public static NotifyCommentService newNotifyCommentService() {
            ...
            return retrofit.create(NotifyCommentService.class);
        }
