...
public final class AutoLinkTextView extends TextView {
    ...
    private Typeface mRobotoBoldFace;
    ...
    private void init() {
        mRobotoBoldFace = Typeface.createFromAsset(getContext().getAssets(), "fonts/Roboto-Black.ttf");
    }
    ...
    private SpannableString makeSpannableString(String text) {
        ...
        for (final AutoLinkItem autoLinkItem : autoLinkItems) {
            ...
            TouchableSpan clickableSpan = new TouchableSpan(currentColor, defaultSelectedColor,isUnderLineEnabled, mRobotoBoldFace) {
                @Override
